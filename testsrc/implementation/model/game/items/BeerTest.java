...
public class BeerTest {
	...
	public void testInstantaneousEffect() {
		beer = ItemFactory.createApple(pointZero, Optional.empty(), Optional.empty());
	...
	public void testLastingEffect() {
		beer = ItemFactory.createApple(pointZero, Optional.empty(), Optional.of(100L));
		Snake testSnake = SnakeFactoryForTests.baseSnake();
		assertFalse(testSnake.getProperties().getDirection().getReverseDirection());
		...
		beer = ItemFactory.createApple(pointZero, Optional.empty(), Optional.of(250L));
