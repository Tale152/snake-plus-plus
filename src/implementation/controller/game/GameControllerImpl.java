...
public class GameControllerImpl implements GameController {
    ...
    private static String collide(final Wall wall, final  List<Wall> allWalls, final Point point) {
    ...
    private String snakeSpriteName(final BodyPart b, final Snake snake) {
        ...
        if (b.isHead() && b.isTail()) {
            ...
            s += isCombined(b.isCombinedOnTop()) + isCombined(b.isCombinedOnRight()) + isCombined(b.isCombinedOnBottom()) + isCombined(b.isCombinedOnLeft());
            return s;
        }
    }
     ...
     * @return true if it the point is inside a range in front of any of the currently alive snakes, false otherwise
     */
 ...
 * @return true if the point is inside a range in front of the given snake, false otherwise
 */
    ...
    @Override
    public void playerInput(final InputEvent input) {
